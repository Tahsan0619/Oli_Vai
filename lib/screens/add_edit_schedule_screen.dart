          ...
          _SectionCard(
            ...
            children: [
              ...
              _LabeledDropdown<String>(
                ...
                hint: 'Select batch',
                items: data.batches.map((b) => DropdownMenuItem(value: b.id, child: Text('${b.name} (${b.session})'))).toList(),
            ...
            children: [
              ...
              if (_selectedMode == 'Onsite') ...[
                ...
                _LabeledDropdown<String>(
                  ...
                  hint: 'Select room',
                  items: data.rooms.map((r) => DropdownMenuItem(value: r.id, child: Text(r.name))).toList(),
